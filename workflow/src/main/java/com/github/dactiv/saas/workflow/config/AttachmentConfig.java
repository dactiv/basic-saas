...
@EqualsAndHashCode
@NoArgsConstructor
@ConfigurationProperties("cmis.workflow.app.attachment")
public class AttachmentConfig {

    /**
     * 桶前缀
     */
    private String bucketPrefix = "cmis.workflow.attachment.";
    ...
    public static class Result {
         ...
         * 链接 uri
         */
        private String linkUri = "/com/github/dactiv/saas/workflow/attachment/get/{0}/{1}";
