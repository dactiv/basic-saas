...
@EqualsAndHashCode
@NoArgsConstructor
@ConfigurationProperties("dactiv.saas.authentication.app.attachment")
public class AttachmentConfig {

    /**
     * 桶前缀
     */
    private String bucketPrefix = "dactiv.saas.basic.attachment.";
    ...
    public static class Result {
         ...
         * 链接 uri
         */
        private String linkUri = "/authentication/attachment/get/{0}/{1}";
