...
public abstract class AbstractRedisCaptchaService<E, C extends ExpiredCaptcha> implements CaptchaService {
    ...
    public BuildToken generateToken(String deviceIdentified) {
        ...
        token.setToken(new CacheProperties(value, captchaConfig.getBuildTokenCache().getExpiresTime()));
    ...
    public String getTokenParamName() {
        return "_" + getType() + StringUtils.capitalize(captchaConfig.getTokenParamNameSuffix());
    }
    ...
    private TimeProperties getRetryTime() {
        return captchaConfig.getCaptchaRetryTime();
    }
    ...
    private String getCaptchaKey(BuildToken buildToken) {
        String name = getType() + ":captcha:" + buildToken.getToken().getName();
        return captchaConfig.getBuildTokenCache().getName(name);
    }
