...
import com.github.dactiv.saas.message.domain.body.sms.SmsMessageBody;
...
public class SmsMessageSender extends BatchMessageSender<SmsMessageBody, SmsMessageEntity> {
    ...
    public static final String DEFAULT_QUEUE_NAME = "dactiv.saas.message.sms.queue";
    ...
    private Stream<SmsMessageEntity> createSmsMessageEntity(SmsMessageBody body) {
        ...
        if (body.getPhoneNumbers().contains(DEFAULT_ALL_USER_KEY)) {
            ...
            for (Map<String, Object> user : users) {
                ...
                entity.setPhoneNumber(user.get(SecurityUserDetailsConstants.SECURITY_DETAILS_PHONE_NUMBER_KEY).toString());
